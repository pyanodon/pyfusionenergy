    ...
    {
        {
            ...
            pipe_picture = Prototype.Pipes.pictures("assembling-machine-3", nil, {-2.0,-4.25}, nil, nil, pipe),
...

        {
            ...
            pipe_picture = Prototype.Pipes.pictures("assembling-machine-3", nil, {-2.00,-4.25}, nil, nil, pipe),
            pipe_covers = Prototype.Pipes.covers(true, true, true, true),
            base_area = 10,
            base_level = -1,
