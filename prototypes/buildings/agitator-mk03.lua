...
if mods.pyrawores then
    RECIPE("agitator-mk03"):add_ingredient_unsafe {type = "item", name = "super-alloy", amount = 20}:add_ingredient_unsafe {type = "item", name = "molybdenum-plate", amount = 15}
end
...
ITEM {
    type = "item",
    name = "agitator-mk03",
    icon = "__pyfusionenergygraphics__/graphics/icons/agitator-mk03.png",
    icon_size = 64,
    flags = {},
    subgroup = "py-fusion-buildings-mk03",
    order = "a",
    place_result = "agitator-mk03",
    stack_size = 10
}
...
ENTITY {
    ...
    minable = {mining_time = 0.5, result = "agitator-mk03"},
