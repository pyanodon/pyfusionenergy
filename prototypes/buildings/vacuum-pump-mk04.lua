...
ENTITY {
    ...
    fluid_boxes = {
        ...
        },
        {
            ...
            volume = 2000,
            pipe_connections = {
                {flow_direction = "input-output", position = {0.0, 1.2}, direction = defines.direction.south},
                {flow_direction = "input-output", position = {0.0, -1.2}, direction = defines.direction.north}
            }
        },
